  ...
  function peg$parse(input, options) {
    ...
    function peg$parseobject() {
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s2 !== peg$FAILED) {
          s3 = peg$parseobject_constant_text();
          if (s3 !== peg$FAILED) {
            ...
            if (s4 !== peg$FAILED) {
              s5 = peg$parsefully_qualified_object_name();
              if (s5 !== peg$FAILED) {
